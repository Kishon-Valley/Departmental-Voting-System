    ...
    <footer className="bg-card border-t mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-serif font-semibold text-lg mb-4">DeptElections</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Empowering democratic participation in departmental governance through secure online voting.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span data-testid="text-footer-email">elections@dept.edu.gh</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Phone className="h-4 w-4" />
                <span data-testid="text-footer-phone">+233 XX XXX XXXX</span>
              </li>
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                <MapPin className="h-4 w-4 mt-0.5" />
                <span data-testid="text-footer-address">Department Office, University Campus</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p data-testid="text-footer-copyright">
            © {new Date().getFullYear()} Department Elections. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
